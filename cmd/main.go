...
import (
	...
	"github.com/fortytwoservices/swagger-importer/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5c08d498.swagger-importer.com",
	...
	if err != nil {
		setupLog.Error(err, "unable to start swagger importer")
		os.Exit(1)
	}
	...
	setupLog.Info("starting Swagger Importer by Fortytwo")
